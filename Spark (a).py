...
overspead_num_times_info = inp.map(lambda line: (line[0],(line[1], g(line[14]),g(line[16]),g(line[15]),g(line[12])))).reduceByKey(lambda a, b: add_tuples(a, b)).coalesce(1)
overspead_num_times_info.saveAsTextFile(out)
